...
def main():
    ...
    xslt_file= os.path.join(my_path, 'marcDataExtract.xsl')
    ...
    the_log = 'Data imported from ' + oai_file + ' by ' + my_name + '. Start: ' + start_time  +  '. Finished: ' + end_time + ' (duration: ' + my_duration + ').'
