...
-->
                <doc>
                  <!-- id -->
                    ...
                    <!-- collectionTitle -->
                    <field name="collectionTitle">
                        <xsl:value-of select="$collectionTitle"/>
                    </field>
                    <!-- collectioTitle_1st -->
                    <field name="collectionTitle_1st">
                        <xsl:value-of select="substring($collectionTitle, 1, 1)"/>
                    </field>
                    <!-- collection_origination -->
                    <field name="collectionOrigination">
                        <xsl:value-of select="$creator"/>
                    </field>
                    <!-- collection_origination_1st -->
                    <field name="collectionOrigination_1st">
...
-->
          <!-- corpname -->
                    ...
                    <!-- digcontent -->
                    <xsl:choose>
                     <xsl:when test="descendant::mrc:datafield[@tag = '856']">
                       <xsl:for-each select="descendant::mrc:datafield[@tag = '856']">
                         <field name="digcontent">
                           <xsl:value-of select="child::mrc:subfield[@code = 'u']"/>
                         </field>
                           <!-- * digcontent_materials -->
                        <field name="digcontent_materials">
                           <xsl:value-of select="child::mrc:subfield[@code = '3']"/>
                         </field>
                           <!-- * digcontent_type -->
                       <field name="digcontent_type">
                           <xsl:value-of select="child::mrc:subfield[@code = 'q']"/>
                         </field>
                           <!-- * digcontent_label -->
                       <field name="digcontent_label">
                           <xsl:value-of select="child::mrc:subfield[@code = 'z']"/>
                         </field>
                       </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template name="processSubjects">
        <xsl:for-each select="child::mrc:subfield[@code != '2']">
            <xsl:value-of select="normalize-space(.)"/>
            <xsl:if test="position() != last()">
                <xsl:choose>
