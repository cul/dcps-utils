...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:output indent="yes"/>
    ...
    <xsl:param name="input_dir">/Users/dwh2128/Documents/git/oai-harvest/output/2020-12-10</xsl:param>
    ...
    <xsl:template match="/">
        ...
        <xsl:message>
            ...
            <xsl:value-of select="count(collection(concat($input_dir, '?select=*.xml;recurse=yes'))/marc:collection/marc:record)"/>
            <xsl:value-of select="$lf"/>
        </xsl:message>
